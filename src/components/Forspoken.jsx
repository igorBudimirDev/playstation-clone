  ...
  return (
    <div className="flex flex-col items-center transition-all duration-75">
      ...
      <div className="flex flex-col gap-7 items-center text-white text-center bg-[#26254f] md:flex-row md:px-7 xl:px-[15em] transition-all duration-75 hover:cursor-pointer pb-10">
        <div className="max-w-[90%] flex flex-col items-center gap-5 hover:cursor-pointer transition-all duration-[0.3s] ease-out hover:scale-[1.05]">
        ...
        <div className="max-w-[90%] flex flex-col items-center gap-5 transition-all duration-[0.3s] hover:cursor-pointer ease-out hover:scale-[1.05]">
