    ...
    >
      <div className="mlb__overlay absolute bottom-[-8rem] w-[100%] min-h-[55%]">
        <div className="flex flex-col items-center absolute bottom-10 gap-2 px-3">
          <img src={MLBHeadImg} alt="" className="max-w-[70%] opacity-0 animate-[appearFromBottom_1s_ease] animation-forwards" />
          <h2 className="text-center text-white text-2xl opacity-0 animate-[appearFromBottom_1s_ease] animation-forwards animation-delay-300">
    ...
    >
      <div className="dead-space__overlay absolute bottom-[-8rem] w-[100%] min-h-[55%]">
        <div className="flex flex-col items-center absolute bottom-10 gap-3 px-3">
          <img src={DeadSpaceHeadImg} alt="" className="max-w-[75%] opacity-0 animate-[appearFromBottom_1s_ease] animation-forwards" />
          <h2 className="text-center text-white text-2xl opacity-0 animate-[appearFromBottom_1s_ease] animation-forwards animation-delay-300">
            Humanity ends here
          </h2>
          <span className="text-center text-white opacity-0 animate-[appearFromBottom_1s_ease] animation-forwards animation-delay-300">
...
const ForSpokenHero = () => {
  return (
    ...
    >
      <div className="forspoken__overlay absolute bottom-[-8rem] w-[100%] min-h-[50%] ">
        <div className="flex flex-col items-center justify-start absolute bottom-7 gap-3 px-3 mb-[10em]">
          <img src={ForSpokenHeadImg} alt="" className="max-w-[75%] opacity-0 animate-[appearFromBottom_1s_ease] animation-forwards" />
          <h2 className="text-center text-white text-2xl opacity-0 animate-[appearFromBottom_1s_ease] animation-forwards animation-delay-300">
            Humanity ends here
          </h2>
          <span className="text-center text-white opacity-0 animate-[appearFromBottom_1s_ease] animation-forwards animation-delay-300">
...
const Hero = () => {
  ...
  return (
    <div className=" flex flex-col justify-center overflow-hidden md:hidden">
      {returnHero()}
      <div
        className={` bg-white w-full flex overflow-x-scroll scroll whitespace-nowrap scroll-smooth scrollbar-hide 
      ${
