...
import DualSensePhone from "../assets/dualsense-md.webp";
import LiveFromPS5Mobile from "../assets/live-from-psp-md.webp";
import LiveFromPS5HeadImg from "../assets/live-from-ps5-head-img.webp";
import MLBMobile from "../assets/mlb-md.webp";
import MLBHeadImg from "../assets/mlb-head-img.webp";
import DeadSpaceMobile from "../assets/dead-space-md.webp";
import DeadSpaceHeadImg from "../assets/dead-space-head-img.webp";
import ForSpokenMobile from "../assets/forspoken-md.webp";
...
const Hero = () => {
  ...
  return (
    <div className="hidden md:flex xl:hidden flex-col justify-center overflow-hidden">
      {returnHero()}
      <div
